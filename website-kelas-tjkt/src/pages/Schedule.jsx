    ...
    <div className="py-12 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Jadwal Pelajaran</h1>
          <p className="text-xl text-gray-600">Kelas XI TJKT 1 - Tahun Ajaran 2025/2026</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          {schedule.map((day, dayIndex) => (
            <div key={day.day} className="card p-6">
              <div className={`${colors[dayIndex]} border-l-4 px-4 py-3 rounded-lg mb-4`}>
